/*
    <Generate from 1bpp_fixedsize_margin_rle.tpl>
...
static const font_table_t freemono24_table[] = {
    ...
    {6, 4, 0, 0, 213},  // FreeMono24_A
    {6, 4, 1, 1, 239},  // FreeMono24_B
    {7, 3, 2, 1, 265},  // FreeMono24_C
    {6, 4, 1, 2, 285},  // FreeMono24_D
    {6, 4, 1, 2, 312},  // FreeMono24_E
    {6, 4, 1, 2, 335},  // FreeMono24_F
    {7, 3, 2, 1, 356},  // FreeMono24_G
    {6, 4, 1, 1, 377},  // FreeMono24_H
    {6, 4, 3, 2, 404},  // FreeMono24_I
    {6, 4, 2, 1, 419},  // FreeMono24_J
    {6, 4, 1, 0, 439},  // FreeMono24_K
    {6, 4, 2, 1, 468},  // FreeMono24_L
    {6, 4, 0, 0, 486},  // FreeMono24_M
    {6, 4, 1, 1, 528},  // FreeMono24_N
    {7, 3, 1, 1, 567},  // FreeMono24_O
    {6, 4, 1, 2, 589},  // FreeMono24_P
    {6, 1, 1, 1, 610},  // FreeMono24_Q
    {6, 4, 1, 0, 637},  // FreeMono24_R
    {7, 3, 2, 2, 664},  // FreeMono24_S
    {6, 4, 2, 1, 682},  // FreeMono24_T
    {6, 4, 1, 1, 700},  // FreeMono24_U
    {6, 4, 1, 0, 728},  // FreeMono24_V
    {6, 4, 1, 1, 755},  // FreeMono24_W
    {6, 4, 1, 1, 798},  // FreeMono24_X
    {6, 4, 2, 1, 824},  // FreeMono24_Y
    {6, 4, 2, 2, 845},  // FreeMono24_Z
    {9, 5, 2, 1, 867},  // FreeMono24_a
    {5, 4, 1, 1, 883},  // FreeMono24_b
    {9, 5, 2, 1, 911},  // FreeMono24_c
    {5, 4, 2, 0, 926},  // FreeMono24_d
    {9, 5, 2, 2, 952},  // FreeMono24_e
    {6, 4, 3, 1, 964},  // FreeMono24_f
    {9, 1, 2, 1, 979},  // FreeMono24_g
    {5, 4, 1, 1, 1006},  // FreeMono24_h
    {5, 4, 2, 2, 1032},  // FreeMono24_i
    {6, 0, 3, 4, 1046},  // FreeMono24_j
    {5, 4, 2, 1, 1063},  // FreeMono24_k
    {5, 4, 2, 2, 1088},  // FreeMono24_l
    {9, 5, 0, 0, 1104},  // FreeMono24_m
    {9, 5, 1, 1, 1134},  // FreeMono24_n
    {9, 5, 2, 1, 1154},  // FreeMono24_o
    {9, 1, 1, 1, 1171},  // FreeMono24_p
    {9, 1, 2, 0, 1198},  // FreeMono24_q
    {9, 5, 2, 1, 1224},  // FreeMono24_r
    {9, 5, 2, 2, 1238},  // FreeMono24_s
    {7, 4, 1, 2, 1251},  // FreeMono24_t
    {9, 5, 1, 1, 1266},  // FreeMono24_u
    {9, 5, 1, 0, 1287},  // FreeMono24_v
    {9, 5, 1, 0, 1307},  // FreeMono24_w
    {9, 5, 1, 1, 1336},  // FreeMono24_x
    {9, 1, 1, 1, 1354},  // FreeMono24_y
    {9, 5, 3, 2, 1378},  // FreeMono24_z
};
