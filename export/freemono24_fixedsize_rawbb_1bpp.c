...
static const font_table_t freemono24_table[] = {
    ...
    {6, 4, 0, 0, 173},  // FreeMono24_A
    {6, 4, 1, 1, 198},  // FreeMono24_B
    {7, 3, 2, 1, 219},  // FreeMono24_C
    {6, 4, 1, 2, 239},  // FreeMono24_D
    {6, 4, 1, 2, 259},  // FreeMono24_E
    {6, 4, 1, 2, 279},  // FreeMono24_F
    {7, 3, 2, 1, 299},  // FreeMono24_G
    {6, 4, 1, 1, 319},  // FreeMono24_H
    {6, 4, 3, 2, 340},  // FreeMono24_I
    {6, 4, 2, 1, 356},  // FreeMono24_J
    {6, 4, 1, 0, 376},  // FreeMono24_K
    {6, 4, 2, 1, 399},  // FreeMono24_L
    {6, 4, 0, 0, 419},  // FreeMono24_M
    {6, 4, 1, 1, 444},  // FreeMono24_N
    {7, 3, 1, 1, 465},  // FreeMono24_O
    {6, 4, 1, 2, 486},  // FreeMono24_P
    {6, 1, 1, 1, 506},  // FreeMono24_Q
    {6, 4, 1, 0, 532},  // FreeMono24_R
    {7, 3, 2, 2, 555},  // FreeMono24_S
    {6, 4, 2, 1, 573},  // FreeMono24_T
    {6, 4, 1, 1, 593},  // FreeMono24_U
    {6, 4, 1, 0, 614},  // FreeMono24_V
    {6, 4, 1, 1, 637},  // FreeMono24_W
    {6, 4, 1, 1, 658},  // FreeMono24_X
    {6, 4, 2, 1, 679},  // FreeMono24_Y
    {6, 4, 2, 2, 699},  // FreeMono24_Z
    {9, 5, 2, 1, 717},  // FreeMono24_a
    {5, 4, 1, 1, 731},  // FreeMono24_b
    {9, 5, 2, 1, 754},  // FreeMono24_c
    {5, 4, 2, 0, 768},  // FreeMono24_d
    {9, 5, 2, 2, 791},  // FreeMono24_e
    {6, 4, 3, 1, 804},  // FreeMono24_f
    {9, 1, 2, 1, 822},  // FreeMono24_g
    {5, 4, 1, 1, 842},  // FreeMono24_h
    {5, 4, 2, 2, 865},  // FreeMono24_i
    {6, 0, 3, 4, 884},  // FreeMono24_j
    {5, 4, 2, 1, 900},  // FreeMono24_k
    {5, 4, 2, 2, 921},  // FreeMono24_l
    {9, 5, 0, 0, 940},  // FreeMono24_m
    {9, 5, 1, 1, 958},  // FreeMono24_n
    {9, 5, 2, 1, 973},  // FreeMono24_o
    {9, 1, 1, 1, 987},  // FreeMono24_p
    {9, 1, 2, 0, 1008},  // FreeMono24_q
    {9, 5, 2, 1, 1029},  // FreeMono24_r
    {9, 5, 2, 2, 1043},  // FreeMono24_s
    {7, 4, 1, 2, 1056},  // FreeMono24_t
    {9, 5, 1, 1, 1074},  // FreeMono24_u
    {9, 5, 1, 0, 1089},  // FreeMono24_v
    {9, 5, 1, 0, 1106},  // FreeMono24_w
    {9, 5, 1, 1, 1123},  // FreeMono24_x
    {9, 1, 1, 1, 1138},  // FreeMono24_y
    {9, 5, 3, 2, 1159},  // FreeMono24_z
};
