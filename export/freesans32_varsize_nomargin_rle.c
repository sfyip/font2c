...
static const uint8_t freesans32_bmp[] = {
    ...
    0x02, 0xF0, 0x3F, 0x02, 0xF0, 0x3F, 0x03, 0xF0, 0x2F, 0x03, 0xF0, 0x3F, 0x03, 0xF0, 0x3E,
    // FreeSans32_8
    ...
    0x8D, 0x3A,
    // FreeSans32_colon
    0xFF, 0xFF, 0xF0, 0x35, 0x35, 0x35, 0x3F, 0xFF, 0xFF, 0xA3, 0x53, 0x53, 0x20,
    // FreeSans32_A
    ...
    0x34, 0xC3, 0x33, 0xD3, 0x33, 0xD4, 0xFC,
    // FreeSans32_B
    ...
    0x49, 0x66, 0x57, 0x31, 0x37, 0xD2, 0x39, 0xA4, 0x2C, 0x4F, 0x10,
    // FreeSans32_H
    ...
    0x46, 0x3A, 0x36, 0x3B, 0x35, 0x3B, 0x4F, 0xC0,
    // FreeSans32_L
    0xFF, 0xB3, 0xF1, 0x3F, 0x13, 0xF1, 0x3F, 0x13, 0xF1, 0x3F, 0x13, 0xF1, 0x3F, 0x13, 0xF1, 0x3F, 0x13, 0xF1, 0x3F, 0x13,
    0xF1, 0x3F, 0x13, 0xF1, 0x3F, 0x13, 0xF1, 0x3F, 0x13, 0xF1, 0x3F, 0x1E, 0x5E, 0x5E, 0xF8,
    // FreeSans32_M
    ...
    0x03, 0x54, 0xD4, 0x64, 0xC3, 0x84, 0x94, 0x95, 0x75, 0xBD, 0xEB, 0xF3, 0x5D,
    // FreeSans32_P
    0xFF, 0xF0, 0xD8, 0xF0, 0x63, 0x75, 0x63, 0x94, 0x53, 0xA3, 0x53, 0xA3, 0x53, 0xA3, 0x53, 0xA3, 0x53, 0xA3, 0x53, 0x94,
    0x5F, 0x06, 0xE7, 0xD8, 0x3F, 0x33, 0xF3, 0x3F, 0x33, 0xF3, 0x3F, 0x33, 0xF3, 0x3F, 0x33, 0xF3, 0x3F, 0x33, 0xFF, 0xC0,
    // FreeSans32_Q
    0xFF, 0xFF, 0x25, 0xF3, 0xBE, 0xDC, 0x47, 0x59, 0x49, 0x48, 0x4B, 0x46, 0x4D, 0x45, 0x3F, 0x03, 0x53, 0xF0, 0x35, 0x3F,
    0x04, 0x33, 0xF2, 0x33, 0x3F, 0x23, 0x33, 0xF2, 0x33, 0x3F, 0x23, 0x33, 0xF2, 0x34, 0x3F, 0x04, 0x43, 0xF0, 0x35, 0x3A,
    0x14, 0x35, 0x49, 0x22, 0x46, 0x47, 0x41, 0x38, 0x47, 0x69, 0x57, 0x5B, 0xF1, 0xBB, 0x14, 0xD4, 0x63, 0xFE,
    // FreeSans32_R
    ...
    0xF3, 0x3F, 0x33, 0xF3, 0x3F, 0x33, 0xF3, 0x3F, 0x33, 0xF3, 0x3F, 0x33, 0xF3, 0x3F, 0x33, 0xFF, 0x60,
    // FreeSans32_U
    ...
    0x49, 0x48, 0x47, 0x4A, 0xDC, 0xBF, 0x15, 0xFF, 0x40,
    // FreeSans32_V
    ...
    0x5F, 0x15, 0xF1, 0x5F, 0x23, 0xFF, 0x60,
    // FreeSans32_W
    ...
    0x23, 0x93, 0x13, 0x63, 0x13, 0xA6, 0x86, 0xA6, 0x86, 0xB5, 0x85, 0xC4, 0xA4, 0xC4, 0xA4, 0xC4, 0xA4, 0xFF, 0xA0,
    // FreeSans32_X
    ...
    0x64, 0x94, 0x53, 0xB4, 0x33, 0xD3, 0xFD,
    // FreeSans32_Y
    ...
    0x4F, 0x04, 0xF0, 0x4F, 0x13, 0xF1, 0x4F, 0x04, 0xF0, 0x4F, 0x13, 0xF1, 0xF3, 0x2F, 0x32, 0xF3, 0xF6,
    // FreeSans32_a
    0xFF, 0xFF, 0xFF, 0xFF, 0xFC, 0xB6, 0x44, 0x46, 0x37, 0x35, 0x37, 0x3F, 0x03, 0xF0, 0x3B, 0x76, 0xC5, 0x73, 0x34, 0x47,
    0x34, 0x38, 0x34, 0x38, 0x34, 0x37, 0x44, 0x36, 0x55, 0xF0, 0x48, 0x24, 0x63, 0x62, 0xF9,
    // FreeSans32_b
    ...
    0x98, 0x95, 0x13, 0x84, 0x23, 0x83, 0x43, 0x73, 0x44, 0x63, 0x53, 0x63, 0x63, 0x53, 0x64, 0x43, 0x73, 0x43, 0x83, 0xF9,
    // FreeSans32_l
    ...
    0x43, 0x72, 0x73, 0x43, 0x72, 0x73, 0x43, 0x72, 0x73, 0x43, 0x72, 0x73, 0x43, 0x72, 0x73, 0x43, 0x72, 0x73, 0xFF, 0x20,
    // FreeSans32_n
    ...
    0x39, 0x33, 0x39, 0x33, 0x39, 0x33, 0x39, 0x34, 0x37, 0x35, 0x45, 0x46, 0xB8, 0x9C, 0x3F, 0xF0,
    // FreeSans32_p
    ...
    0x23, 0x83, 0x33, 0x63, 0x4C, 0x5A, 0x94, 0xF7,
    // FreeSans32_t
    ...
    0x36, 0x34, 0x28, 0x23, 0x38, 0x32, 0x38, 0x32, 0x2A, 0x21, 0x3A, 0x5B, 0x5C, 0x4C, 0x37,
    // FreeSans32_w
    ...
    0x5B, 0x69, 0x31, 0x38, 0x33, 0x37, 0x34, 0x35, 0x35, 0x34, 0x37, 0x33, 0x37, 0x41,
    // FreeSans32_y
...
static const font_table_t freesans32_table[] = {
    ...
    {18, 26, 45},  // FreeSans32_1
    {18, 26, 80},  // FreeSans32_2
    {18, 27, 114},  // FreeSans32_3
    {18, 26, 153},  // FreeSans32_4
    {18, 27, 192},  // FreeSans32_5
    {18, 27, 230},  // FreeSans32_6
    {18, 26, 273},  // FreeSans32_7
    {18, 27, 308},  // FreeSans32_8
    {18, 27, 351},  // FreeSans32_9
    {8, 26, 393},  // FreeSans32_colon
    {22, 26, 406},  // FreeSans32_A
    {22, 26, 453},  // FreeSans32_B
    {23, 27, 496},  // FreeSans32_C
    {23, 26, 540},  // FreeSans32_D
    {21, 26, 585},  // FreeSans32_E
    {20, 26, 622},  // FreeSans32_F
    {25, 27, 658},  // FreeSans32_G
    {24, 26, 709},  // FreeSans32_H
    {9, 26, 757},  // FreeSans32_I
    {17, 27, 782},  // FreeSans32_J
    {22, 26, 814},  // FreeSans32_K
    {19, 26, 862},  // FreeSans32_L
    {28, 26, 897},  // FreeSans32_M
    {24, 26, 981},  // FreeSans32_N
    {26, 27, 1044},  // FreeSans32_O
    {21, 26, 1097},  // FreeSans32_P
    {26, 28, 1137},  // FreeSans32_Q
    {23, 26, 1195},  // FreeSans32_R
    {22, 27, 1240},  // FreeSans32_S
    {21, 26, 1282},  // FreeSans32_T
    {24, 27, 1319},  // FreeSans32_U
    {21, 26, 1368},  // FreeSans32_V
    {30, 26, 1415},  // FreeSans32_W
    {22, 26, 1494},  // FreeSans32_X
    {22, 26, 1541},  // FreeSans32_Y
    {20, 26, 1583},  // FreeSans32_Z
    {18, 26, 1620},  // FreeSans32_a
    {18, 27, 1655},  // FreeSans32_b
    {17, 26, 1700},  // FreeSans32_c
    {18, 27, 1731},  // FreeSans32_d
    {18, 26, 1776},  // FreeSans32_e
    {9, 26, 1809},  // FreeSans32_f
    {18, 33, 1834},  // FreeSans32_g
    {18, 26, 1886},  // FreeSans32_h
    {8, 26, 1930},  // FreeSans32_i
    {8, 33, 1952},  // FreeSans32_j
    {17, 26, 1981},  // FreeSans32_k
    {7, 26, 2021},  // FreeSans32_l
    {26, 26, 2045},  // FreeSans32_m
    {18, 26, 2105},  // FreeSans32_n
    {18, 26, 2146},  // FreeSans32_o
    {18, 33, 2182},  // FreeSans32_p
    {18, 33, 2233},  // FreeSans32_q
    {11, 26, 2283},  // FreeSans32_r
    {16, 26, 2307},  // FreeSans32_s
    {9, 27, 2335},  // FreeSans32_t
    {18, 27, 2359},  // FreeSans32_u
    {16, 26, 2400},  // FreeSans32_v
    {24, 26, 2435},  // FreeSans32_w
    {16, 26, 2499},  // FreeSans32_x
    {16, 33, 2533},  // FreeSans32_y
    {16, 26, 2575},  // FreeSans32_z
};
