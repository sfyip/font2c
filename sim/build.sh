...
# adaptive font size
gcc -o lcd_sim2_adapt_size -DCONFIG_FONT_FIXED_WIDTH_HEIGHT=0 -DCONFIG_FONT_MARGIN=1 -DCONFIG_FONT_ENC=0 main.c lcd_sim.c freesans32_adapt_size_margin_raw.c