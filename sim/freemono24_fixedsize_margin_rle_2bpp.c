/*
    <Generate from 2bpp_fixedsize_margin_rle.tpl>
...
static const font_table_t freemono24_table[] = {
    ...
    {6, 4, 0, 0, 315, 161},  // FreeMono24_A
    {6, 4, 1, 1, 347, 177},  // FreeMono24_B
    {6, 3, 1, 1, 380, 194},  // FreeMono24_C
    {6, 4, 1, 1, 414, 211},  // FreeMono24_D
    {6, 4, 1, 1, 454, 231},  // FreeMono24_E
    {6, 4, 1, 1, 484, 246},  // FreeMono24_F
    {6, 3, 1, 0, 510, 259},  // FreeMono24_G
    {6, 4, 1, 1, 546, 277},  // FreeMono24_H
    {6, 4, 3, 2, 584, 296},  // FreeMono24_I
    {6, 4, 2, 0, 606, 307},  // FreeMono24_J
    {6, 4, 1, 0, 630, 319},  // FreeMono24_K
    {6, 4, 1, 1, 667, 338},  // FreeMono24_L
    {6, 4, 0, 0, 693, 351},  // FreeMono24_M
    {6, 4, 1, 1, 748, 379},  // FreeMono24_N
    {6, 3, 1, 1, 795, 403},  // FreeMono24_O
    {6, 4, 1, 2, 829, 420},  // FreeMono24_P
    {6, 1, 1, 1, 856, 434},  // FreeMono24_Q
    {6, 4, 1, 0, 897, 455},  // FreeMono24_R
    {6, 3, 2, 2, 930, 472},  // FreeMono24_S
    {6, 4, 1, 1, 963, 489},  // FreeMono24_T
    {6, 4, 1, 1, 991, 503},  // FreeMono24_U
    {6, 4, 0, 0, 1027, 521},  // FreeMono24_V
    {6, 4, 1, 0, 1063, 539},  // FreeMono24_W
    {6, 4, 1, 0, 1119, 567},  // FreeMono24_X
    {6, 4, 1, 1, 1156, 586},  // FreeMono24_Y
    {6, 4, 2, 2, 1188, 602},  // FreeMono24_Z
    {9, 4, 2, 1, 1214, 615},  // FreeMono24_a
    {5, 4, 0, 1, 1238, 627},  // FreeMono24_b
    {9, 4, 2, 1, 1278, 647},  // FreeMono24_c
    {5, 4, 1, 0, 1301, 659},  // FreeMono24_d
    {9, 4, 1, 1, 1337, 677},  // FreeMono24_e
    {5, 4, 2, 1, 1361, 689},  // FreeMono24_f
    {9, 0, 1, 0, 1385, 701},  // FreeMono24_g
    {5, 4, 1, 1, 1425, 721},  // FreeMono24_h
    {5, 4, 2, 2, 1461, 739},  // FreeMono24_i
    {5, 0, 3, 3, 1482, 749},  // FreeMono24_j
    {5, 4, 1, 1, 1507, 762},  // FreeMono24_k
    {5, 4, 2, 2, 1542, 780},  // FreeMono24_l
    {9, 4, 0, 0, 1566, 792},  // FreeMono24_m
    {9, 4, 1, 1, 1609, 814},  // FreeMono24_n
    {9, 4, 2, 1, 1639, 829},  // FreeMono24_o
    {9, 0, 0, 1, 1665, 842},  // FreeMono24_p
    {9, 0, 1, 0, 1705, 862},  // FreeMono24_q
    {10, 4, 2, 1, 1743, 881},  // FreeMono24_r
    {9, 4, 2, 2, 1760, 890},  // FreeMono24_s
    {6, 4, 1, 2, 1785, 903},  // FreeMono24_t
    {9, 4, 1, 1, 1809, 915},  // FreeMono24_u
    {10, 4, 1, 0, 1837, 929},  // FreeMono24_v
    {10, 4, 1, 0, 1862, 942},  // FreeMono24_w
    {10, 4, 1, 1, 1899, 961},  // FreeMono24_x
    {9, 0, 1, 1, 1924, 974},  // FreeMono24_y
    {10, 4, 3, 2, 1956, 990},  // FreeMono24_z
};
